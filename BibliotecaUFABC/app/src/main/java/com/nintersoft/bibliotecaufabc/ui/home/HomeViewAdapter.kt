...
class HomeViewAdapter : RecyclerView.Adapter<HomeViewAdapter.HomeBookViewHolder>(){

    private val books = AppDatabase.getInstance()?.bookSearchDAO()?.getAll()
    ...
    override fun getItemCount(): Int {
        return  if (books == null || books.value == null) 0 else books.value?.size!!
    }
