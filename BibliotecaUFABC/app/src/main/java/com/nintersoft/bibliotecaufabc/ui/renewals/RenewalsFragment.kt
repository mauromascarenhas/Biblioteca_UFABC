...
class RenewalsFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        menu.findItem(R.id.action_refresh).isEnabled = SyncService.status == SyncService.Companion.LStatus.STOPPED
    ...
    private fun configureObservers(){
        ...
        SyncService.observableStatus.observe(viewLifecycleOwner, Observer {
